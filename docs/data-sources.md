...
| France · Tours notices, 3 Feb 2025 consultations, nationwide BOAMP sample | `tours-notices*.json`, `consultations*.json`, `contracts.json`, `boamp-raw.json.gz`, `coverage.json` | BOAMP (DILA), boamp.fr open-data API; TED XML for Tours | To confirm: the BOAMP API metadata states no licence |
